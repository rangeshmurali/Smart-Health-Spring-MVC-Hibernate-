...
public class HospitalFinanceManagerValidator implements Validator {
	
	@Override
	public boolean supports(Class<?> clazz) {
		// TODO Auto-generated method stub
		return HospitalFinanceManager.class.equals(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {
		// TODO Auto-generated method stub
		HospitalFinanceManager financeManager = (HospitalFinanceManager)target; 
