...
<div id="wrapper">
		...
		<div class="row">
                    <div class="col-lg-12">
                        ...
                        <form:form action="deleteHospital" method="POST" commandName="hospital" role="form" name="myForm">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td><input type="checkbox" name="delete" value="${hospital.hospitalId}" />Remove hospital</td>
									</tr>
									</c:forEach>
                                </tbody>
                            </table>
