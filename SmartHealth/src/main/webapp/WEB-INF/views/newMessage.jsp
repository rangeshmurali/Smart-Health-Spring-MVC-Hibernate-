        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		...
			    		<form:form action="newMessageToDoctor" method="POST" commandName="message" role="form" name="myForm">
			    			...
			    			<div class="row">
			    				<div class="col-xs-12 col-sm-12 col-md-12">
			    					<div class="form-group">
			                			<form:input path="userName" name="userName" id="userName" class="form-control input-sm" placeholder="To Doctor UserName" required="true"  />
