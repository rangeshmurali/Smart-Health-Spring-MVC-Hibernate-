...
<div id="wrapper">
		...
		<div class="row">
                    <div class="col-lg-12">
                        ...
                        <form:form action="deleteUser" method="POST" commandName="message" role="form" name="myForm">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td><a href="replyUser?doctorUserName=${message.fromUser}" class="btn btn-info btn-block">Reply</a></td>
                            ...
                            <div class="col-lg-6">
                            <a href="sendMessageUser" class="btn btn-info btn-block"> Send New Message </a> <br />
                            </div>
                            <div class="col-lg-6">
