        ...
        if (str == "") {
            ...
            xmlhttp.onreadystatechange = function() {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                	...
                	document.getElementById("error").innerHTML = "No data found for selected date!!";
                }
            }
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title">Select Date to View The Records!</h3>
			 			</div>
			 			<div class="panel-body">
			 			<div id="error" style="color: red; font-weight:bole; text-align:center; margin-bottom:10px;">${error}</div>
			    		<form:form action="updateRecord" method="POST" commandName="dailyRecord" role="form" name="myForm" id="myForm">			    	
			    		<div id="username" style="color: green; font-weight:bole; text-align:center; margin-bottom:10px;">${success}</div>
			    		<div class="row">
			    			<div class="col-xs-6 col-sm-6 col-md-6">
			    				<div class="form-group">
			    					<form:input path="date" type="date" name="date" id="name" onchange="showUser(this.value)" />	
			    				</div>
			    			</div>
			    		</div>
			    			<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			                			<form:input path="walkingDistance" type="number" step="0.01" name="walkingDistance" id="walkingDistance" class="form-control input-sm" placeholder="Walking Distance" />
			                			<form:errors path="walkingDistance" cssStyle="color:#ff0000"/>
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<form:input path="runningDistance" type="number" step="0.01" name="runningDistance" id="runningDistance" class="form-control input-sm" placeholder="Running Distance" />
			    			...
			    			<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			                			<form:input path="flightsClimed" type="number" name="flightsClimed" id="flightsClimed" class="form-control input-sm" placeholder="Flights Climed" />
			                			<form:errors path="flightsClimed" cssStyle="color:#ff0000"/>
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<form:input path="activeCalories" type="number" step="0.01" name="activeCalories" id="activeCalories" class="form-control input-sm" placeholder="Active Calories" />
			    			...
			    			<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			                			<form:input path="bloodPressure" name="bloodPressure" id="bloodPressure" class="form-control input-sm" placeholder="Blood Pressure" />
			                			<form:errors path="bloodPressure" cssStyle="color:#ff0000"/>
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<form:input path="heartRate" type="number" name="heartRate" id="heartRate" class="form-control input-sm" placeholder="Heart Rate" />
